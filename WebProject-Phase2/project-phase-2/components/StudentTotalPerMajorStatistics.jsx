...
import { getTotalNumberOfStudentsPerMajor } from '@/app/Actions/server-actions';
...
export default function StudentStatistics() {
    ...
    useEffect(() => {
        async function fetchData() {
          const result = await getTotalNumberOfStudentsPerMajor();
          result.sort((a, b) => b._count.major - a._count.major);
          setData(result);
        }
        fetchData();
      }, []);
